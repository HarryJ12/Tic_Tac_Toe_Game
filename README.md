...
cleanly through a dedicated TicTacToe class. Mouse clicks map directly to board cells, turns alternate automatically, and the 
system locks further moves once a win condition appears.
